...
# ISL map to indicate the PEs that will produce the output wavelets
output_port_map = "{out_tensor[idx=0:3] -> [PE[idx,0] -> index[0]]}"
...
np.testing.assert_equal(result, [42, 43, 44, 45])
print("SUCCESS!")
